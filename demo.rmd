...
```{r, fig.cap="fALFF", rgl=TRUE, format="png", fig.height=3, fig.width=4}
# [Use `view_xifti_surface` here.]
# view_xifti_surface(
```

```{r, fig.cap="fALFF, subcortex", rgl=TRUE, format="png", fig.height=4, fig.width=2.5}
...
```{r parc, fig.cap='Parcellation', fig.width=4, fig.height=3}
# View(parc$meta$cifti$labels$parcels["Key"])
plot(parc, title="Parcellation")
```

```{r parc2, fig.cap='Selected parcel', fig.width=4, fig.height=3}
...
```{r seedCor, fig.cap='Seed correlation', fig.width=4, fig.height=3}
